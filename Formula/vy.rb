class Vy < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/antonmagnus/vy/releases/download/v#{version}/vy-aarch64-macos.tar.gz"
      sha256 "cd1aafd5ebbe3a37c971370331955142580db9683cd096b729d70ce0c68b90c5"
    end
    on_intel do
      url "https://github.com/antonmagnus/vy/releases/download/v#{version}/vy-x86_64-macos.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/antonmagnus/vy/releases/download/v#{version}/vy-aarch64-linux.tar.gz"
      sha256 "32a64766231f4e48930c0d996715d5ae280723998ff4f22be7393173625cd024"
    end
    on_intel do
      url "https://github.com/antonmagnus/vy/releases/download/v#{version}/vy-x86_64-linux.tar.gz"
